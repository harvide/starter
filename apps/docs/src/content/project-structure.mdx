...
The Harvide Starter project uses a monorepo structure with `turborepo`, organizing code into packages and applications for better maintainability and reuse.

## Root Directory

- `apps/`: Contains the main application code
  - `client/`: The Next.js application that includes both frontend and admin panel
